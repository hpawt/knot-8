...
Write-Host "Run    : tp2b compiler tests"
& python (Join-Path $projectRoot "tools\test_tp2bc.py")
if ($LASTEXITCODE -ne 0) {
    throw "tp2b compiler tests failed"
}

Write-Host "All Knot-8 v4 simulations and toolchain tests passed." -ForegroundColor Green
